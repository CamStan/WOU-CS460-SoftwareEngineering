<?php include ('layouts/header.php'); ?>
    ...
    <center><h1>A Little About Me...</h1></center>
    <div id="about" class="row">
       <!-- Picture of me in left column -->
        <div id="aboutImage" class="col-md-6">
            <img src="images/Me.png" alt="Cameron">
        </div>
        <!-- Information about me in right column -->
        <div class="col-md-6">
            ...
            <p>In my spare time I love spending time with my wife and cat, 3D printing, and traveling and discovering new parts of the world.</p>
        </div>
    </div>
